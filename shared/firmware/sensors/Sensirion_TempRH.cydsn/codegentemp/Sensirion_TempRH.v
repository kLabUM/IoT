// ======================================================================
// Sensirion_TempRH.v generated from TopDesign.cysch
// 02/24/2016 at 23:10
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2C_v3_30"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2C_v3_30\bI2C_v3_30.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2C_v3_30"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2C_v3_30\bI2C_v3_30.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__Sensirion_Power_net;
	wire [0:0] tmpFB_0__Sensirion_Power_net;
	wire [0:0] tmpIO_0__Sensirion_Power_net;
	wire [0:0] tmpINTERRUPT_0__Sensirion_Power_net;
	electrical [0:0] tmpSIOVREF__Sensirion_Power_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3dba336a-f6a5-43fb-aed3-de1e0b7bf362"),
		  ...
		  .width(1))
		Sensirion_Power
		 (.oe(tmpOE__Sensirion_Power_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sensirion_Power_net[0:0]}),
		  .io({tmpIO_0__Sensirion_Power_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensirion_Power_net),
		  .interrupt({tmpINTERRUPT_0__Sensirion_Power_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sensirion_Power_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
