// ======================================================================
// Maxbotix.v generated from TopDesign.cysch
// 02/22/2016 at 23:02
...
module top ;
    ...
    UART_v2_30_0 UART_Maxbotix (
        ...
        .rx_data(Net_12),
        .rx_clk(Net_13));
    defparam UART_Maxbotix.Address1 = 0;
    defparam UART_Maxbotix.Address2 = 0;
    defparam UART_Maxbotix.EnIntRXInterrupt = 0;
    defparam UART_Maxbotix.EnIntTXInterrupt = 0;
    defparam UART_Maxbotix.FlowControl = 0;
    defparam UART_Maxbotix.HalfDuplexEn = 0;
    defparam UART_Maxbotix.HwTXEnSignal = 1;
    defparam UART_Maxbotix.NumDataBits = 8;
    defparam UART_Maxbotix.NumStopBits = 1;
    defparam UART_Maxbotix.ParityType = 0;
    defparam UART_Maxbotix.RXEnable = 1;
    defparam UART_Maxbotix.TXEnable = 0;

	wire [0:0] tmpOE__Maxbotix_RX_net;
	wire [0:0] tmpIO_0__Maxbotix_RX_net;
	wire [0:0] tmpINTERRUPT_0__Maxbotix_RX_net;
	electrical [0:0] tmpSIOVREF__Maxbotix_RX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .width(1))
		Maxbotix_RX
		 (.oe(tmpOE__Maxbotix_RX_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__Maxbotix_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__Maxbotix_RX_net),
		  .interrupt({tmpINTERRUPT_0__Maxbotix_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Maxbotix_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Maxbotix_Power_net;
	wire [0:0] tmpFB_0__Maxbotix_Power_net;
	wire [0:0] tmpIO_0__Maxbotix_Power_net;
	wire [0:0] tmpINTERRUPT_0__Maxbotix_Power_net;
	electrical [0:0] tmpSIOVREF__Maxbotix_Power_net;
	...
	cy_psoc3_pins_v1_10
		...
		Maxbotix_Power
		 (.oe(tmpOE__Maxbotix_Power_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Maxbotix_Power_net[0:0]}),
		  .io({tmpIO_0__Maxbotix_Power_net[0:0]}),
		  .siovref(tmpSIOVREF__Maxbotix_Power_net),
		  .interrupt({tmpINTERRUPT_0__Maxbotix_Power_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Maxbotix_Power_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
