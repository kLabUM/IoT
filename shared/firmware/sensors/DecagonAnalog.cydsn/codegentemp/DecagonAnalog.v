// ======================================================================
// DecagonAnalog.v generated from TopDesign.cysch
// 02/22/2016 at 23:39
...
module top ;
	...
	wire [0:0] tmpOE__VWC_1_net;
	wire [0:0] tmpFB_0__VWC_1_net;
	wire [0:0] tmpIO_0__VWC_1_net;
	wire [0:0] tmpINTERRUPT_0__VWC_1_net;
	electrical [0:0] tmpSIOVREF__VWC_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		VWC_1
		 (.oe(tmpOE__VWC_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VWC_1_net[0:0]}),
		  .analog({Net_27}),
		  .io({tmpIO_0__VWC_1_net[0:0]}),
		  .siovref(tmpSIOVREF__VWC_1_net),
		  .interrupt({tmpINTERRUPT_0__VWC_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VWC_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VWC_3_net;
	wire [0:0] tmpFB_0__VWC_3_net;
	wire [0:0] tmpIO_0__VWC_3_net;
	wire [0:0] tmpINTERRUPT_0__VWC_3_net;
	electrical [0:0] tmpSIOVREF__VWC_3_net;

	cy_psoc3_pins_v1_10
		#(.id("40047ac5-4b75-4a2b-8f87-de77abbeb8d8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VWC_3
		 (.oe(tmpOE__VWC_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VWC_3_net[0:0]}),
		  .analog({Net_63}),
		  .io({tmpIO_0__VWC_3_net[0:0]}),
		  .siovref(tmpSIOVREF__VWC_3_net),
		  .interrupt({tmpINTERRUPT_0__VWC_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VWC_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VWC_4_net;
	wire [0:0] tmpFB_0__VWC_4_net;
	wire [0:0] tmpIO_0__VWC_4_net;
	wire [0:0] tmpINTERRUPT_0__VWC_4_net;
	electrical [0:0] tmpSIOVREF__VWC_4_net;

	cy_psoc3_pins_v1_10
		#(.id("d0243369-a988-4434-8f31-c9d162c2b826"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VWC_4
		 (.oe(tmpOE__VWC_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VWC_4_net[0:0]}),
		  .analog({Net_29}),
		  .io({tmpIO_0__VWC_4_net[0:0]}),
		  .siovref(tmpSIOVREF__VWC_4_net),
		  .interrupt({tmpINTERRUPT_0__VWC_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VWC_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VWC_2_net;
	wire [0:0] tmpFB_0__VWC_2_net;
	wire [0:0] tmpIO_0__VWC_2_net;
	wire [0:0] tmpINTERRUPT_0__VWC_2_net;
	electrical [0:0] tmpSIOVREF__VWC_2_net;

	cy_psoc3_pins_v1_10
		#(.id("dcdd12ba-88ba-415a-83a1-3056259b282d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VWC_2
		 (.oe(tmpOE__VWC_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VWC_2_net[0:0]}),
		  .analog({Net_28}),
		  .io({tmpIO_0__VWC_2_net[0:0]}),
		  .siovref(tmpSIOVREF__VWC_2_net),
		  .interrupt({tmpINTERRUPT_0__VWC_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VWC_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Power_VWC_1_net;
	wire [0:0] tmpFB_0__Power_VWC_1_net;
	wire [0:0] tmpIO_0__Power_VWC_1_net;
	wire [0:0] tmpINTERRUPT_0__Power_VWC_1_net;
	electrical [0:0] tmpSIOVREF__Power_VWC_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VWC_1
		 (.oe(tmpOE__Power_VWC_1_net),
		  .y({Net_55}),
		  .fb({tmpFB_0__Power_VWC_1_net[0:0]}),
		  .io({tmpIO_0__Power_VWC_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VWC_1_net),
		  .interrupt({tmpINTERRUPT_0__Power_VWC_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VWC_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Power_Reg (
        .control_1(Net_52),
        .control_2(Net_53),
        .control_3(Net_54),
        .control_0(Net_55),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Power_Reg.Bit0Mode = 0;
    defparam Power_Reg.Bit1Mode = 0;
    defparam Power_Reg.Bit2Mode = 0;
    defparam Power_Reg.Bit3Mode = 0;
    defparam Power_Reg.Bit4Mode = 0;
    defparam Power_Reg.Bit5Mode = 0;
    defparam Power_Reg.Bit6Mode = 0;
    defparam Power_Reg.Bit7Mode = 0;
    defparam Power_Reg.BitValue = 15;
    defparam Power_Reg.BusDisplay = 0;
    defparam Power_Reg.ExtrReset = 0;
    defparam Power_Reg.NumOutputs = 4;

	wire [0:0] tmpOE__Power_VWC_2_net;
	wire [0:0] tmpFB_0__Power_VWC_2_net;
	wire [0:0] tmpIO_0__Power_VWC_2_net;
	wire [0:0] tmpINTERRUPT_0__Power_VWC_2_net;
	electrical [0:0] tmpSIOVREF__Power_VWC_2_net;

	cy_psoc3_pins_v1_10
		#(.id("38bfe4fd-8c43-413f-831e-951f4791a629"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VWC_2
		 (.oe(tmpOE__Power_VWC_2_net),
		  .y({Net_52}),
		  .fb({tmpFB_0__Power_VWC_2_net[0:0]}),
		  .io({tmpIO_0__Power_VWC_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VWC_2_net),
		  .interrupt({tmpINTERRUPT_0__Power_VWC_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VWC_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Power_VWC_3_net;
	wire [0:0] tmpFB_0__Power_VWC_3_net;
	wire [0:0] tmpIO_0__Power_VWC_3_net;
	wire [0:0] tmpINTERRUPT_0__Power_VWC_3_net;
	electrical [0:0] tmpSIOVREF__Power_VWC_3_net;

	cy_psoc3_pins_v1_10
		#(.id("42f4b283-1273-4c50-8397-2cf1983f879d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VWC_3
		 (.oe(tmpOE__Power_VWC_3_net),
		  .y({Net_53}),
		  .fb({tmpFB_0__Power_VWC_3_net[0:0]}),
		  .io({tmpIO_0__Power_VWC_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VWC_3_net),
		  .interrupt({tmpINTERRUPT_0__Power_VWC_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VWC_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Power_VWC_4_net;
	wire [0:0] tmpFB_0__Power_VWC_4_net;
	wire [0:0] tmpIO_0__Power_VWC_4_net;
	wire [0:0] tmpINTERRUPT_0__Power_VWC_4_net;
	electrical [0:0] tmpSIOVREF__Power_VWC_4_net;

	cy_psoc3_pins_v1_10
		#(.id("04816b2b-b22b-4fe7-829d-e6f55102d089"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VWC_4
		 (.oe(tmpOE__Power_VWC_4_net),
		  .y({Net_54}),
		  .fb({tmpFB_0__Power_VWC_4_net[0:0]}),
		  .io({tmpIO_0__Power_VWC_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VWC_4_net),
		  .interrupt({tmpINTERRUPT_0__Power_VWC_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VWC_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
