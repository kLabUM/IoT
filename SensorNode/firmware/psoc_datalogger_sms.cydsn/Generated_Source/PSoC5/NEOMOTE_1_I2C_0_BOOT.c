/*******************************************************************************
* File Name: NEOMOTE_1_I2C_0_BOOT.c
* Version 3.30
*
* Description:
...
static uint8 XDATA NEOMOTE_1_I2C_0_slReadBuf[NEOMOTE_1_I2C_0_BTLDR_SIZEOF_READ_BUFFER];

/* I2C read buffer: Host reads responses from it */
static uint8 XDATA NEOMOTE_1_I2C_0_slWriteBuf[NEOMOTE_1_I2C_0_BTLDR_SIZEOF_WRITE_BUFFER];


/*******************************************************************************
* Function Name: NEOMOTE_1_I2C_0_CyBtldrCommStart
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  NEOMOTE_1_I2C_0_slWriteBuf - used to store received command.
*  NEOMOTE_1_I2C_0_slReadBuf - used to store response.
...
{
    /* Set Write buffer */
    NEOMOTE_1_I2C_0_SlaveInitWriteBuf(NEOMOTE_1_I2C_0_slWriteBuf, NEOMOTE_1_I2C_0_BTLDR_SIZEOF_WRITE_BUFFER);

    /* Set Read buffer which has zero elements */
    NEOMOTE_1_I2C_0_SlaveInitReadBuf(NEOMOTE_1_I2C_0_slReadBuf, 0u);

    /* Enable power to I2C Module */
    NEOMOTE_1_I2C_0_Start();
}


/*******************************************************************************
* Function Name: NEOMOTE_1_I2C_0_CyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: NEOMOTE_1_I2C_0_CyBtldrCommReset
********************************************************************************
*
* Summary:
...
void NEOMOTE_1_I2C_0_CyBtldrCommReset(void) CYSMALL 
{
    ...
    NEOMOTE_1_I2C_0_slRdBufSize = 0u;
    ...
    NEOMOTE_1_I2C_0_slStatus = 0u;
}


/*******************************************************************************
* Function Name: NEOMOTE_1_I2C_0_CyBtldrCommWrite
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
cystatus NEOMOTE_1_I2C_0_CyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut) CYSMALL
    ...
    if((NULL != pData) && (size > 0u))
    {
        ...
        *count = size;  /* Buffer was copied to I2C buffer */
        ...
        while(0u != timeoutMs)  /* Wait till response will be read */
        {
            ...
            CyDelay(NEOMOTE_1_I2C_0_WAIT_1_MS);
            timeoutMs--;
        }
    }
...
/*******************************************************************************
* Function Name: NEOMOTE_1_I2C_0_CyBtldrCommRead
********************************************************************************
*
* Summary:
         ...
         
{
    ...
    if((NULL != pData) && (size > 0u))
    {
        ...
        while(0u != timeoutMs)  /* Wait for command from the host */
        {
            ...
            if(0u != (NEOMOTE_1_I2C_0_slStatus & NEOMOTE_1_I2C_0_SSTAT_WR_CMPLT))
            {
                /* How many bytes the host has been written */
                byteCount = NEOMOTE_1_I2C_0_slWrBufIndex;
                *count = (uint16) byteCount;

                /* Copy command to pData buffer */
                (void) memcpy((void *) pData, (void *) NEOMOTE_1_I2C_0_slWriteBuf,
                              NEOMOTE_1_I2C_0_MIN_UNT16(byteCount, size));
