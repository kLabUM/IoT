...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480000ACu)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480000B8u)
...
#define BS_IOPORT_1_VAL ((const uint8 CYFAR *)0x480000E8u)

/* IOPORT_7 Address: CYDEV_PRTDSI_PRT12_BASE Size (bytes): 6 */
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x480000F0u)
