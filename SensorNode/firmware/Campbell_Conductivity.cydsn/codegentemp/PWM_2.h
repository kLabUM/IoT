...
#else
    #define PWM_2_UseStatus 0u
#endif /* !defined(PWM_2_PWMUDB_sSTSReg_stsreg__REMOVED) */
#if !defined(PWM_2_PWMUDB_sCTRLReg_ctrlreg__REMOVED)
    #define PWM_2_UseControl 1u
#else
    #define PWM_2_UseControl 0u
#endif /* !defined(PWM_2_PWMUDB_sCTRLReg_ctrlreg__REMOVED) */
...
**************************************/
#define PWM_2_INIT_PERIOD_VALUE        10u
...
******************************** */
   ...
   #define PWM_2_AUX_CONTROLDP0_PTR  ((reg8 *) PWM_2_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
    ...
    /* In Fixed Function Block these bits are in the control blocks control register */
        ...
        #define PWM_2_DEADBAND_COUNT        (*(reg8 *) PWM_2_PWMUDB_sDB3_SyncCtl_dbctrlreg__CONTROL_REG)
        #define PWM_2_DEADBAND_COUNT_PTR     ((reg8 *) PWM_2_PWMUDB_sDB3_SyncCtl_dbctrlreg__CONTROL_REG)
        #define PWM_2_DEADBAND_COUNT_MASK    (uint8)((uint8)0x03u << PWM_2_DEADBAND_COUNT_SHIFT) 
...
#else
    #define PWM_2_STATUS                (*(reg8 *) PWM_2_PWMUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define PWM_2_STATUS_PTR            ((reg8 *) PWM_2_PWMUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define PWM_2_STATUS_MASK           (*(reg8 *) PWM_2_PWMUDB_sSTSReg_rstSts_stsreg__MASK_REG)
    #define PWM_2_STATUS_MASK_PTR       ((reg8 *) PWM_2_PWMUDB_sSTSReg_rstSts_stsreg__MASK_REG)
    #define PWM_2_STATUS_AUX_CTRL       (*(reg8 *) PWM_2_PWMUDB_sSTSReg_rstSts_stsreg__STATUS_AUX_CTL_REG)
    #define PWM_2_CONTROL               (*(reg8 *) PWM_2_PWMUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG)
    #define PWM_2_CONTROL_PTR           ((reg8 *) PWM_2_PWMUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG)
