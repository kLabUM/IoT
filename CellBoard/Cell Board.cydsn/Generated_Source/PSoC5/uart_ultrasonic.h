...
#define uart_ultrasonic_TX_ENABLED                     (0u)
...
#ifdef uart_ultrasonic_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG
    #define uart_ultrasonic_CONTROL_REG_REMOVED            (0u)
#else
    #define uart_ultrasonic_CONTROL_REG_REMOVED            (1u)
#endif /* End uart_ultrasonic_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG */
...
***************************************/
    ...
    #define uart_ultrasonic_CONTROL_REG \
                            (* (reg8 *) uart_ultrasonic_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG )
