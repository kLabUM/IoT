...
#define uart_ultrasonic_IntClock_SetDivider(clkDivider)         uart_ultrasonic_IntClock_SetDividerRegister(clkDivider, 1u)
#define uart_ultrasonic_IntClock_SetDividerValue(clkDivider)    uart_ultrasonic_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define uart_ultrasonic_IntClock_SetPhaseValue(clkPhase)        uart_ultrasonic_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(uart_ultrasonic_IntClock__CFG3) */
