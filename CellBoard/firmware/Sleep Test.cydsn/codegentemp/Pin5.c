...
{
    uint8 staticBits = (Pin5_DR & (uint8)(~Pin5_MASK));
    Pin5_DR = staticBits | ((uint8)(value << Pin5_SHIFT) & Pin5_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin5_0, mode);
}
...
{
    return (Pin5_PS & Pin5_MASK) >> Pin5_SHIFT;
}
...
{
    return (Pin5_DR & Pin5_MASK) >> Pin5_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (Pin5_INTSTAT & Pin5_MASK) >> Pin5_SHIFT;
    }
