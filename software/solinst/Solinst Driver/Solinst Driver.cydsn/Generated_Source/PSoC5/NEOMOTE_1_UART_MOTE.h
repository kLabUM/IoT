...
#ifdef NEOMOTE_1_UART_MOTE_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG
    #define NEOMOTE_1_UART_MOTE_CONTROL_REG_REMOVED            (0u)
#else
    #define NEOMOTE_1_UART_MOTE_CONTROL_REG_REMOVED            (1u)
#endif /* End NEOMOTE_1_UART_MOTE_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG */
...
***************************************/
    ...
    #define NEOMOTE_1_UART_MOTE_CONTROL_REG \
                            (* (reg8 *) NEOMOTE_1_UART_MOTE_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG )
