...
#ifdef uart_solinst_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG
    #define uart_solinst_CONTROL_REG_REMOVED            (0u)
#else
    #define uart_solinst_CONTROL_REG_REMOVED            (1u)
#endif /* End uart_solinst_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG */
...
***************************************/
    ...
    #define uart_solinst_CONTROL_REG \
                            (* (reg8 *) uart_solinst_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG )
