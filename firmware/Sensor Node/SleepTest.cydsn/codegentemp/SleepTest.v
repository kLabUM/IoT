// ======================================================================
// SleepTest.v generated from TopDesign.cysch
// 11/24/2013 at 16:09
...
module I2C_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("983457ee-12eb-431c-a174-960e8b66f712/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("fb1666c9-c987-4d0f-8168-298e160d8d70"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1e195e1f-d5fe-4b3d-8719-249841583bfd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0257c50a-0449-4f52-abde-667f8f687f9f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63730f27-f280-4617-b733-668534c1cfb3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3aed50d9-7364-4f18-8146-c52caec5d64c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6f2cbb88-3c87-4ddf-aa0f-97ea265ea8cc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4530150f-68f6-4629-bf3f-fda5bcbefea6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e3f2b15e-a804-437e-b4e9-aa44b3fa53a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("86b5f5e0-27db-4dbc-92dd-c3ca5f0db2cd"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__inbt2_net;
	wire [0:0] tmpFB_0__inbt2_net;
	wire [0:0] tmpIO_0__inbt2_net;
	wire [0:0] tmpINTERRUPT_0__inbt2_net;
	electrical [0:0] tmpSIOVREF__inbt2_net;

	cy_psoc3_pins_v1_10
		#(.id("b0d4c8c1-e985-463a-9264-6881a5ebee72"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		inbt2
		 (.oe(tmpOE__inbt2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__inbt2_net[0:0]}),
		  .io({tmpIO_0__inbt2_net[0:0]}),
		  .siovref(tmpSIOVREF__inbt2_net),
		  .interrupt({tmpINTERRUPT_0__inbt2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__inbt2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__crustal_net;
	wire [0:0] tmpFB_0__crustal_net;
	wire [0:0] tmpIO_0__crustal_net;
	wire [0:0] tmpINTERRUPT_0__crustal_net;
	electrical [0:0] tmpSIOVREF__crustal_net;

	cy_psoc3_pins_v1_10
		#(.id("64d778aa-ff7f-4b1d-9347-b9f897fc30aa"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		crustal
		 (.oe(tmpOE__crustal_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__crustal_net[0:0]}),
		  .io({tmpIO_0__crustal_net[0:0]}),
		  .siovref(tmpSIOVREF__crustal_net),
		  .interrupt({tmpINTERRUPT_0__crustal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__crustal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("513b1b27-0f06-4350-92fd-ce88566d827d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("598a123c-6725-4b0c-a140-627c033357e7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
