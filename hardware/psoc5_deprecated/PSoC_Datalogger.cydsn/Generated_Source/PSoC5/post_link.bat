...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\karunmj\Documents\GitHub\m2m\hardware\psoc5_deprecated\PSoC_Datalogger.cydsn\PSoC_Datalogger.svd" rem "C:\Users\karunmj\Documents\GitHub\m2m\hardware\psoc5_deprecated\PSoC_Datalogger.cydsn\PSoC_Datalogger.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
