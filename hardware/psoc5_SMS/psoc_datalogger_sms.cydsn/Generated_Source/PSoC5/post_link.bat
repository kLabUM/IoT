...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\karunmj\Documents\GitHub\m2m\hardware\psoc5_SMS\PSoC_Datalogger_SMS.cydsn\PSoC_Datalogger_SMS.svd" rem "C:\Users\karunmj\Documents\GitHub\m2m\hardware\psoc5_SMS\PSoC_Datalogger_SMS.cydsn\PSoC_Datalogger_SMS.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
