...
#define BS_UDB_0_3_1_CONFIG_VAL ((const uint8 CYFAR *)0x480006E8u)
...
#define BS_IOPORT_0_VAL ((const uint8 CYFAR *)0x48000794u)

/* IOPORT_4 Address: CYDEV_PRTDSI_PRT4_BASE Size (bytes): 7 */
#define BS_IOPORT_4_VAL ((const uint8 CYFAR *)0x4800079Cu)
