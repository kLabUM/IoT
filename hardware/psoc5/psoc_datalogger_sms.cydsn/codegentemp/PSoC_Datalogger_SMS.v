...
module top ;
    ...
    emFile_v1_20_4 emFile_1 ();

    NEOMOTE_7 NEOMOTE_1 ();

    UART_v2_30_8 uart_solinst (
        .cts_n(1'b0),
        .tx(Net_634),
        .rts_n(Net_725),
        .tx_en(Net_726),
	...
	assign tmpOE__uart_solinst_tx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_738} : {Net_738};
