...
module top ;
    ...
    UART_v2_30_2 ultrasonic_uart (
        ...
        .rx_data(Net_628),
        .rx_clk(Net_629));
    defparam ultrasonic_uart.Address1 = 0;
    defparam ultrasonic_uart.Address2 = 0;
    defparam ultrasonic_uart.EnIntRXInterrupt = 0;
    defparam ultrasonic_uart.EnIntTXInterrupt = 0;
    defparam ultrasonic_uart.FlowControl = 0;
    defparam ultrasonic_uart.HalfDuplexEn = 0;
    defparam ultrasonic_uart.HwTXEnSignal = 1;
    defparam ultrasonic_uart.NumDataBits = 8;
    defparam ultrasonic_uart.NumStopBits = 1;
    defparam ultrasonic_uart.ParityType = 0;
    defparam ultrasonic_uart.RXEnable = 1;
    defparam ultrasonic_uart.TXEnable = 1;
