...
#define BS_UDB_0_5_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800081Cu)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800089Cu)
...
#define BS_IOPORT_0_VAL ((const uint8 CYFAR *)0x480008CCu)

/* IOPORT_1 Address: CYDEV_PRTDSI_PRT1_BASE Size (bytes): 7 */
#define BS_IOPORT_1_VAL ((const uint8 CYFAR *)0x480008D4u)

/* IOPORT_5 Address: CYDEV_PRTDSI_PRT5_BASE Size (bytes): 7 */
#define BS_IOPORT_5_VAL ((const uint8 CYFAR *)0x480008DCu)
