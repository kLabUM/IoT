...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\karunmj\Google Drive\SURE\Resources\PSoC\PSoC5\PSoC_Datalogger.cydsn\PSoC_Datalogger.svd" rem "C:\Users\karunmj\Google Drive\SURE\Resources\PSoC\PSoC5\PSoC_Datalogger.cydsn\PSoC_Datalogger.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
